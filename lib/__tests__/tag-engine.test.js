...
test('PRECISION-6: Solutions Architect → entry_level (guard)', () => {
  assert.strictEqual(tagEmployment(makeJob('Solutions Architect')), 'entry_level');
});

test('PRECISION-6: Solution Architect → entry_level (guard)', () => {
  assert.strictEqual(tagEmployment(makeJob('Solution Architect')), 'entry_level');
});

test('PRECISION-6: Business Architect → entry_level (guard)', () => {
  assert.strictEqual(tagEmployment(makeJob('Business Architect')), 'entry_level');
});

test('PRECISION-6: Sales Architect → entry_level (guard)', () => {
  assert.strictEqual(tagEmployment(makeJob('Sales Architect')), 'entry_level');
});

test('PRECISION-6: Pre-Sales Architect → entry_level (guard)', () => {
  assert.strictEqual(tagEmployment(makeJob('Pre-Sales Architect')), 'entry_level');
});

test('PRECISION-6: Architect, Solutions → entry_level (reversed variant)', () => {
  assert.strictEqual(tagEmployment(makeJob('Architect, Solutions')), 'entry_level');
});
