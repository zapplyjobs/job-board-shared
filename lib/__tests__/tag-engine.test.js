...
test('associate director → entry_level (TAG-22)', () => {
  assert.strictEqual(tagEmployment(makeJob('Associate Director')), 'entry_level');
});
...
test('associate architect → entry_level (TAG-22)', () => {
  assert.strictEqual(tagEmployment(makeJob('Associate Architect')), 'entry_level');
});
...
test('tagJob associate director is entry_level + domain correct', () => {
