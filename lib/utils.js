...
function getExperienceLevel(title, description = '', config) {
  // Seniority signals checked on TITLE ONLY — job descriptions routinely say
  // "work with senior engineers" regardless of the actual level of the role,
  // causing 80%+ of entry-level jobs to be incorrectly filtered out.
  ...
  // obvious keywords are likely entry-level.
  return 'Entry-Level';
}
