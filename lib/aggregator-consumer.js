  ...
  return {
    ...
    async fetchJobsWithDiagnostics() {
      try {
        ...
        // Enrichment merge available via mergeEnrichmentData() export but NOT called
        // automatically. Consumer READMEs are a discovery surface (funnel top) — enrichment
        // data (skills, visa, summary) belongs on the job board website and extension.
