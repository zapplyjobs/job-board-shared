...
function normalizeLeverJob(job, companySlug, companyName) {
    ...
    return {
        ...
        // If the original date is older than 14 days, use fetch time instead — this makes the job
...
async function fetchAllLeverJobs(companies, options = {}) {
    ...
    console.log(`\n🎯 Fetching from ${companies.length} Lever boards (concurrency: ${concurrency})...`);
