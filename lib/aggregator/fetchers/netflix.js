...
async function fetchAllNetflixJobs() {
  ...
  // Descriptions NOT fetched inline — 251 sequential HTTP requests took ~3 min
  // for only 22 pool jobs. Tag-engine uses departments[] for classification.
  // Jobs enter enrichment as T0. Revisit if Netflix descriptions become critical.
