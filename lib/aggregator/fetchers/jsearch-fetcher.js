 ...
 * - 17 queries total (software:4, datascience:4, hardware:5, general_tech:4)
...
const QUERY_SETS = {
  ...
  // General Tech — broad catch-all for intern + entry-level tech roles
  // Added JS-5: nursing removed (well-covered by Workday/GH); slots reallocated here
  general_tech: [
