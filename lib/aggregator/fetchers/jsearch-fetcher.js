...
// 17 total: rotates 1 per run (every 15 min) = full cycle every ~4.25 hours
const ALL_QUERIES = [
  ...QUERY_SETS.software,
...
function selectQueriesForRun(runIndex) {
  // 96 runs/day (every 15 min), 17 queries total
  // Full cycle every 17 runs (~4.25 hours) — all domains covered ~5.6x per day
