 ...
 * - Greenhouse (33 companies)
 * - Lever (3 companies)
 * - Ashby (10 companies)
 * - Workday (21 tenants)
 *
 * Total: 67 companies/tenants
 */
...
function getUsageStats() {
    return {
        companies_total: companyList.greenhouse.length + companyList.lever.length + companyList.ashby.length + (companyList.workday ? companyList.workday.length : 0),
