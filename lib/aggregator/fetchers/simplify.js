 ...
 * platforms (iCIMS, Taleo, Avature, proprietary portals). Oracle HCM reopened F21 — public REST API discovered.
 *
...
const TARGET_COMPANIES = [
  // Auth-walled ATS (iCIMS, Taleo, Avature). Oracle HCM reopened F21 (public REST API).
