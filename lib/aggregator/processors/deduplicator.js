...
function deduplicateJobs(jobs) {
  ...
  // The store tracks across runs, but if a fetcher returns the same job twice
  // in one pagination pass (Hitachi WD, Amazon), both copies would be added
  // because the second one sees seenById=true and passes through.
  // This set catches that: first occurrence goes to activeWindow, second is skipped.
