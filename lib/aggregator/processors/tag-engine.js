...
function tagDomains(job, options) {
  ...
  const softwareKeywords = [
    ...
    'broadcom administrator',        // 2 gen, 0 FP — VMware/Broadcom admin (CACI)
    'itsm administrator',            // 1 gen, 0 FP — ITSM/ServiceNow admin
    'application administrator',     // 1 gen, 0 FP — application admin (CACI)
  ...
  const operationsKeywords = [
    ...
    // TAG-11 S238: adaptive classifier cycle 4
    'intel analyst',             // 1 gen, 0 FP — intelligence analyst (defense)
    'operations integrator',     // 1 gen, 0 FP — military operations integrator
    'sensitive activities',      // 1 gen, 0 FP — sensitive activities advisor (defense)
    'procurement administrator', // 1 gen, 0 FP — procurement admin
    'governance documentation',  // 1 gen, 0 FP — governance documentation (defense)
    'governance framework',      // 1 gen, 0 FP — governance framework analysis
    'interface sustainment',     // 2 gen, 0 FP — interface sustainment analyst (CACI)
