...
function tagDomains(job, options) {
  ...
  if (matchesHardware) {
    ...
    if (!isOnlyServiceTech && !isCloudOpsEng && !isWaterUtilityFSR && !isVeoliaFieldOps && !isIntuitiveClinicalFP && !isNCRFieldOps && !isBakerFieldOps && !isTradesOnly && !isSoftwarePrimaryRole && !isSupplyChainEng) {
