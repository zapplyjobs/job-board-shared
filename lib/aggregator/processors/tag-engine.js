...
function tagDomains(job, options) {
  ...
  if (deptRaw) {
    const DEPT_RULES = [
      [/\b(software|platform eng|web eng|mobile eng|data eng|backend|frontend|devops|sre|infra eng|security eng|it eng|product engineering)\b/i, 'software'],
      ...
      [/\b(hardware|electrical|mechanical|embedded|firmware|test eng|systems eng|manufacturing eng|materials eng)\b/i, 'hardware'],
      ...
      [/\b(finance|accounting|treasury|tax |fp&a|financial)\b/i, 'finance'],
      [/\b(legal|compliance|regulatory|counsel)\b/i, 'legal'],
      [/\b(human resource|people|talent|recruiting|hr )\b/i, 'hr'],
      [/\b(operations|ops |customer (experience|success|care|support)|fleet|supply chain)\b/i, 'operations'],
