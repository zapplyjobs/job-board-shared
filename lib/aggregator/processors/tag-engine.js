...
function tagDomains(job, options) {
  ...
  if (matchesHardware) {
    ...
    // keywords but produce zero skills — Philips/ASML/Baker Hughes have legitimate hardware
    // FSEs and must NOT be guarded globally.
    ...
    if (!(isOnlyServiceTech && isCustomerServiceTech) && !isCloudOpsEng && !isWaterUtilityFSR && !isVeoliaFieldOps && !isIntuitiveClinicalFP) {
