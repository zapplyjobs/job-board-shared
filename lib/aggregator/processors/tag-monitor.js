  ...
  const domainChecks = {
    software: {
      ...
      fpPatterns: [
        ...
        // B28: site reliability matching technician titles
        { pattern: /\bsite reliability\b.*\btechnicians?\b/i, reason: 'site reliability tech (not SWE) B28' },
      ],
    },
    hardware: {
      label: 'Hardware',
      ...
      fpPatterns: [
        ...
        // B28: embedded matching sales/finance/consultant titles
        { pattern: /\bembedded\b.*\b(sales|finance|consultant|account|representative)\b/i, reason: 'embedded sales/finance (not HW) B28' },
        // B28: automated logic matching sales titles
        { pattern: /\bautomated logic\b.*\b(sales|representative|manager)\b/i, reason: 'automated logic sales (not HW) B28' },
      ],
    },
    healthcare: {
      label: 'Healthcare',
      ...
      fpPatterns: [
        ...
        // B28: hardware/mechanical roles misrouted to healthcare
        { pattern: /\b(mechanical|hardware|sensing).*(technician|lab|engineer)\b/i, reason: 'mechanical/hardware tech (not clinical) B28' },
      ],
    },
    data_science: {
      label: 'Data Science',
      jobs: usJobs.filter(j => j.tags && j.tags.domains && j.tags.domains.includes('data_science')),
      fpPatterns: [
        // B28: 'data' substring matching non-DS roles
        { pattern: /\b(mechanical|product|materials).*(data specialist|data entry)\b/i, reason: 'non-DS data role B28' },
        { pattern: /\bai\b.*\b(sales|account|representative)\b/i, reason: 'AI sales role (not DS)' },
      ],
    },
  };
