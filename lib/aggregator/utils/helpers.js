...
// Single source of truth for employment type normalization (AGG-PIPE-13).
// Used in: carry-forward merge, Step 2 enhance, generateMetadata.
const EMPLOYMENT_NORMALIZE_MAP = {
  'FULL-TIME': 'FULL_TIME',
  'FULLTIME': 'FULL_TIME',
  'PART-TIME': 'PART_TIME',
  'PARTTIME': 'PART_TIME',
  'INTERNSHIP': 'INTERN',
  'TEMPORARY': 'CONTRACT',
  'FULL-TIME AND INTERNSHIP': 'FULL_TIME,INTERN',
  'FULL-TIME AND PART-TIME': 'FULL_TIME,PART_TIME',
};
...
function isInternship(job) {
  ...
  // Normalize employment_types to always be an array (some sources return string or array)
