...
class PipelineTracer {
    ...
    constructor(enabled = false) {
        // Singleton pattern - only one tracer per process
        // If instance exists AND enabled states match, return existing
        if (PipelineTracer.instance && PipelineTracer.instance.enabled === enabled) {
            return PipelineTracer.instance;
        }

        // If enabled state changed, create new instance
