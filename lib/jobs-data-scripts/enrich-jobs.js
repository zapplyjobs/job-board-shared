...
// Config
// ---------------------------------------------------------------------------
const ENRICHER_VERSION = 42;   // ENR-VISA-5: 29 LCA aliases for prefix-match removal companies (Oracle, Meta, Apple, Google, TikTok, ByteDance, etc.)
...
const FAST_SOURCES = new Set(['workday', 'smartrecruiters', 'jsearch', 'amazon', 'netflix', 'eightfold', 'oracle', 'microsoft', 'amd', 'uber']);
...
const LCA_COMPANY_ALIASES = {
  ...
  'Bloomberg Industry Group': 'bloomberg l p',
  ...
  'Curtiss-Wright': 'curtiss wright flow control',
  'Decagon': 'decagon ai',
  'Dell Technologies': 'dell products l p',
  'Disney': 'disney streaming enterprises',
  ...
  'Point72': 'point72 asset management l p',
  'Ramp': 'ramp business',
  'Red Bull': 'red bull north america',
  'Relativity Space': 'relativity oda',
  'Ripple': 'ripple labs',
  'Robinhood': 'robinhood markets',
  'SanDisk': 'sandisk technologies',
  'SEL': 'schweitzer engineering laboratories',
  'Sentry': 'sentry insurance a mutual',
  'SharkNinja': 'sharkninja operating',
  'Sift': 'sift science',
  ...
  'TeleTracking Technologies': 'teletracking',
...
function isPossibleSponsor(companyName, lcaSet) {
  ...
  if (alias && lcaSet.has(alias)) return true;
  return null;
}
