...
// Config
// ---------------------------------------------------------------------------
const ENRICHER_VERSION = 44;   // ENR-ALIAS-5: 6 new LCA aliases (AES Corp, Brex, Figure AI, Intrinsic Robotics, Target, Waymo) + Figure AI variant
const SLOW_BATCH_SIZE = 200;   // GH, Ashby/Lever — HTTP calls per job (ENR-49: 120→200)
const FAST_BATCH_SIZE = 500;  // WD, SR, Amazon, Netflix, EF — CPU only
const FAST_SOURCES = new Set(['workday', 'smartrecruiters', 'amazon', 'netflix', 'eightfold', 'oracle', 'microsoft', 'amd', 'uber']);
