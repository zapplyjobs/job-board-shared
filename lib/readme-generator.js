...
| *No current openings* | *Check back tomorrow* | *-* | *-* | *-* |`;
    ...
    Object.entries(jobCategories).forEach(([categoryKey, categoryData]) => {
      ...
      categoryJobs.forEach((job) => {
        ...
        const cleanLink = applyLink.replace(/[?&]utm_[^)&]*/g, '').replace(/[?&]$/, '');
        output += `| ${emoji} **${companyName}** | ${role}${statusIndicator} | ${location} | ${posted} | [<img src="images/apply.png" width="75" alt="Apply">](${cleanLink}) |\n`;
      });
